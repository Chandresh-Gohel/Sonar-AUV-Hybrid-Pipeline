...
# --- Configuration ---
MODEL_PATHS = {
    "yolov5nu": r'runs\detect\yolov5n_100e_run\weights\best.pt',
    "yolov5su": r'runs\detect\yolov5s_100e_run\weights\best.pt',
    "yolov8n": r'runs\detect\yolov8n_100e_run\weights\best.pt',
    "yolov8s": r'runs\detect\yolov8s_100e_run\weights\best.pt',
    "yolo11n": r'runs\detect\yolo11n_100e_run\weights\best.pt',
    "yolo11s": r'runs\detect\yolo11s_100e_run\weights\best.pt',
    "yolo26n": r'runs\detect\yolo26n_100e_run\weights\best.pt',
    "yolo26s": r'runs\detect\yolo26s_100e_run\weights\best.pt',
}
VAL_CSV_PATH = 'cfc_tiny_test.csv'
VAL_IMG_DIR = r'sonar_yolo_dataset\images\val'
...
IMG_SIZE = 512
VIS_OUTPUT_ROOT = r'runs\inference_vis_2' # Root folder for saved visualizations
# ---
