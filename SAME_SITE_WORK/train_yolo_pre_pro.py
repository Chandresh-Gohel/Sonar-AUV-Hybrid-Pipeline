...
# --- Configuration ---
DATASET_CONFIG = 'sonar_dataset_pre_pro.yaml'
EPOCHS = 100 # Your 50-epoch requirement
IMG_SIZE = 512
...
if __name__ == "__main__":
    ...
    if not os.path.exists(DATASET_CONFIG):
        ...
        train_yolo(
            ...
            run_name='yolov5n_pre_pro_run_100e'
        )
        
        # 2. Train YOLOv8n
        train_yolo(
            model_name='yolov8n.pt', 
            run_name='yolov8n_pre_pro_run_100e'
        )
        # 3. Train YOLOv5s
        train_yolo(
            model_name='yolov5s.pt', 
            run_name='yolov5s_pre_pro_run_100e'
        )
        
        # 4. Train YOLOv8s
        train_yolo(
            model_name='yolov8s.pt', 
            run_name='yolov8s_pre_pro_run_100e'
        )

        # 5. Train YOLOv11s
        train_yolo(
            model_name='yolo11s.pt', 
            run_name='yolo11s_pre_pro_run_100e'
        )
        # 6. Train YOLOv11n
        train_yolo(
            model_name='yolo11n.pt', 
            run_name='yolo11n_pre_pro_run_100e'
        )
        # 7. Train YOLOv26n
        train_yolo(
            model_name='yolo26n.pt', 
            run_name='yolo26n_pre_pro_run_100e'
        )
        # 8. Train YOLOv26s
        train_yolo(
            model_name='yolo26s.pt', 
            run_name='yolo26s_pre_pro_run_100e'
        )
