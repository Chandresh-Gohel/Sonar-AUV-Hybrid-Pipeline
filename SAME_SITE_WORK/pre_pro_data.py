...
# -------------------------------
# --- 1. SET YOUR PATHS ---
# The root folder containing all raw data (e.g., .../raw)
# Override with environment variables or edit directly.
ROOT_INPUT_DIR  = os.environ.get("SONAR_INPUT_DIR",  "./data/raw")

# Where to save the mirrored output structure
ROOT_OUTPUT_DIR = os.environ.get("SONAR_OUTPUT_DIR", "./data_preprocessed/raw")
