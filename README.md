...
6. Train/evaluate YOLO (e.g. YOLOv5/YOLOv8/YOLOv11/YOLOv26 via Ultralytics)
...
## Demo
<image-card alt="Sonar preprocessing demo" src="images/demo_sonar_pre_pro.gif" ></image-card>
